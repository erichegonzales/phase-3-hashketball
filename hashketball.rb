...
#     team_hash.each do |team_attribute, attribute_data|
#       if team_attribute == :players
#         attribute_data.each do |player_data|
#           return player_data[:points] if player_data[:player_name] == player
#         end
#       end
#     end
#   end
...
#       if team_attribute == :players
#         attribute_data.each do |player_data|
#           return player_data[:shoe] if player_data[:player_name] == player
#         end
#       end
#     end
#   end
...
#   game_hash.each do |team_type, team_hash|
#     return team_hash[:colors] if team_hash[:team_name] == team
#   end
# end
...
#   name_arr = []
#   game_hash.each do |team_type, team_hash|
#     name_arr.push(team_hash[:team_name])
#   end
#   name_arr
# end
...
#       if team_attribute == :players
#         attribute_data.each do |player_data|
#           jersey_arr.push(player_data[:number]) if team_hash[:team_name] == team
#         end
#       end
#     end
#   end
...
#       if team_attribute == :players
#         attribute_data.each do |player_data|
#           shoe_sizes.push(player_data[:shoe])
#         end
#         attribute_data.each do |player_data|
#         return player_data[:rebounds] if player_data[:shoe] == shoe_sizes.max
#         end
#       end
#     end
#   end
